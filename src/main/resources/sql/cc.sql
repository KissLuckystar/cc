...
CREATE TABLE `t_contents`(
  ...
  `categories` varchar(200) DEFAULT '0',
  `hits` int(10) unsigned DEFAULT '0',
  `commentNum` int(10) unsigned DEFAULT '0',
...
CREATE TABLE `t_logs`(
  ...
  `action` varchar(200) DEFAULT NULL COMMENT '事件',
...
-- ----------------------------
INSERT INTO `t_users` VALUES ('1', 'admin', 'a66abb5684c45962d887564f08346e8d', '2685331701@qq.com', null, 'admin', '1490756162', '0', '0', 'visitor');
